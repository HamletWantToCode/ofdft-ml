...
pca = PrincipalComponentAnalysis(13)
...
plt.plot(np.arange(0, 13, 1), dEkxt_test[0], 'ro-', label='true')
plt.plot(np.arange(0, 13, 1), dEkxt_predict[0], 'bo--', label='predict', fillstyle='none')
